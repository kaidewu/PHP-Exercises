...
$cfg["dbPersonasTablaA"] = "$cfg[mysqlDatabaseA].persona_a";   // Nombre de la tabla Personas
...
function borraTodo()
{
    ...
    $consulta = "DROP TABLE IF EXISTS $cfg[dbPersonasTablaA]";
    ...
    print "\n";
        ...
        $consulta = "CREATE TABLE $cfg[dbPersonasTablaA]  (
