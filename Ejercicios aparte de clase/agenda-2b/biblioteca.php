...
function cabecera($texto, $menu)
{
    ...
    print "  <link rel=\"stylesheet\" href=\"agenda_2b.css\" title=\"Color\">\n";
    print "</head>\n";
    print "\n";
    print "<body>\n";
    print "  <header>\n";
...
function pie()
{
    ...
    print "      <time datetime=\"2022-01-25\">25 de enero de 2022</time>\n";
    print "    </p>\n";
    print "\n";
    print "    <p class=\"licencia\">\n";
    print "      Este programa forma parte del curso <strong><a href=\"https://www.google.es\">\n";
