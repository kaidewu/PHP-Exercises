...
$cfg["dbPersonasTablaB"] = "$cfg[mysqlDatabase].personas_b";   // Nombre de la tabla Personas
...
function borraTodo()
{
    ...
    $consulta = "DROP TABLE IF EXISTS $cfg[dbPersonasTablaB]";
    ...
    print "\n";
        ...
        $consulta = "CREATE TABLE $cfg[dbPersonasTablaB]  (
