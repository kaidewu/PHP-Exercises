...
$cfg["dbPersonasTamEmail"]  = 50;        // Tamaño de la columna Personas > Teléfono
...
function cabecera($texto, $menu)
{
    ...
    print "  <title>\n";
    print "    $texto. Bases de datos (2 B) 1. Bases de datos (2 B).\n";
    print "    Kaide Wu\n";
    print "  </title>\n";
    ...
    print "<body>\n";
    print "  <header>\n";
    print "    <h1>Bases de datos (2 B) 1 - $texto</h1>\n";
    print "\n";
    print "    <nav>\n";
    print "      <ul>\n";
